[
  ...
  },
  {
    ...
    origin: "Yelp",
    description:
      "Coolest, funnest place ever, Kinka replicates the liveliness and atmosphere of a traditional Izakaya in Japan very well, the staff greets you on entry and exit, all the staff is extraordinarily friendly, the service is quick, and the food was amazing. Our reservation had hand cligraphied cards on them! We ordered fried chicken, torched salmon, takoyaki and black sesame ice cream, they were all superb! Cheaper than most Japanese restaurants with solid food quality and a fun atmosphere, what more can you ask for?\nThe only little complaint i have is the salmon was not as torched (charred) as what we had in Montreal's Kinka, so it was less good, but overall still a place I would return to regularly if I lived in Toronto!",
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "Was really pleased with the quality of the food - especially the sashimi. You should know that the restaurant is very loud because the food servers greet everyone who enters the restaurant by yelling at the top of their lungs, and whenever a table orders sake, a group of the servers go to the table, yell and pound on the table with their hands. It seems fun if you know what you're in for, but not a place for quiet conversation.",
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "Really enjoyed the food and would recommend but it was super noisy. It's fine cause it's part of the experience but I went with friends I hadn't seen in ages and it made it difficult to catch up. If we had known ahead of time we might have chosen somewhere else.",
  ...
  },
  {
    ...
    origin: "Yelp",
    description:
      "This is definitely one of my favorite bars/restaurants in Toronto after trying it last week.  Came here with a group of 4 without knowing what to expect but was blown away.  First off, the atmosphere was really fun.  They offer sake bombs so you will hear people screaming and banging on the tables every few minutes.  The food was served tapas style and I got to try about 6-7 different dishes which were all really good.  The ones that stood out to me were the oysters(kakimayo), salmon tataki, and the yaki udon.  You can't really go wrong with this place for a night out with your friends and family.",
    datePublished: "2018-07-05",
    summary:
  ...
  },
  {
    id: 24,
    rating: "4.0",
    author: "WellTraveledEthiopia",
    origin: "TripAdvisor",
    description:
      "As you walk into this restaurant the chefs shout out their hellos in Japanese and this continues throughout the evening so not a great place for conversations or in my case catching up with my brothers and their family.The food though was great -we had edamame beans, sushi, tempura prawns and chicken, rapini vegetable stir fry.The Kinoko Bibimap which is rice, mushroom, cheese and seaweed served in a sizzling stone bowl was excellent.",
  ...
  },
  {
    ...
    origin: "Yelp",
    description:
      "This place was a go-to cool hip crazy line up plaace when I was in highschool a few years ago. Now we go for beers and good japanese bar dishes which are always excellent but on the more expensive side every once in a while.",
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "I liked this place so much, I went here two nights in a row during my short visit in Toronto. There are so many good options on the menu, I ended up trying a lot. They take reservations, but those fill up really quick. You can walk-in and more are likely to get a table if you come in early. This place is very small and busy. They're also intentionally very loud. The workers yell everything.",
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "I want to preface this review by saying that this place looks fun to visit as a large group. They have big communal tables, lots of noise, and sake bombs galore. I came alone (I was visiting Toronto for a few days), and this was just not what I was looking for. First, it was very loud. The gimmick is that the servers shout in Japanese whenever someone comes through the door, leaves, places an order, there's an order up, or gets a sake bomb. In the latter case, the servers chant while the person bangs loudly on the table. Again - probably fun if you're into that kind of thing, but otherwise just very loud. I ordered two things - the yuzu tofu (similar to agadashi tofu) which arrived pretty soggy unfortunately, and the special oyster hot pot, which had exactly one oyster and the rest was cabbage (taste was okay though). I was also very crowded. On the bright side, the servers were very polite and attentive and clearly working very hard. I just can't really recommend this place based on the atmosphere or the food.",
