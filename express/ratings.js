let Ratings = [
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "We had been wanting to try Momofuku for a while after recommendations from multiple people.Tables are communal which I have no problem with, layout and decor of the venue was nice.My boyfriend and I started off with the bbq pork buns - oh my goodness, these were sensational! The pork was tender, crunchy slaw and great sauce. You must try them if you dine here.We all selected different flavours of ramen - i ordered the pork ramen; the noodles were nice and the pork belly was fantastic. My boyfriend chose the duck ramen, which he enjoyed. The chicken ramen was praised by one of our friends but he commented that the broth could be better.Love the Milk Bar concept upstairs. It’s a self serve dessert bar filled with the famous crack pie (a butter pie with oat crust) - it was delicious. Our friend chose the chocolate chip truffle balls while my boyfriend opted for the chocolate cookie. He noted that it was a bit stale so perhaps stick to the crack pie.Nice drinks list as well, I recommend the cranberry same slushie - very refreshing!Service was good, very welcoming and happy to answer any questions we had.Fun place to dine and yes, it’s more expensive than other ramen places but it was a nice experience overall.",
  ...
  },
  {
    ...
    summary:
      "Located at the corner of Shangri-La hotel on University Avenue, a few minutes away from City Hall, Momofuko’s famous entrance has a giant sparking statue and was featured in “Miss Sloan”.",
    concepts: [
      { content: "tavern" },
      { content: "compass" },
      { content: "statue" },
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "Great produce, great food and great atmosphere. I had the kimchi jar, the okonomiyaki and chicken nugget bao’s. I’ll be back to try the ramen and the spicy noodles.",
    datePublished: "2018-06-19",
    summary: "I had the kimchi jar, the okonomiyaki and chicken nugget bao’s.",
    concepts: [
      { content: "food" },
      { content: "atmosphere" },
      { content: "bottle" },
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "It’s easy to make a reservation online which I would highly recommend as the cue was very long for those who didn’t. The food was ok, nothing was wrong with it but really not anything special and there were no stand out dishes. The service was ok - but again not fantastic. Overall it’s a nice enough place to go, but I wouldn’t go out of my way to visit. There’s also a lot better dining options elsewhere in Downtown Toronto. ",
    datePublished: "2018-03-11",
    summary:
      "Overall it’s a nice enough place to go, but I wouldn’t go out of my way to visit.",
    concepts: [
      { content: "online" },
      { content: "food" },
      { content: "special" },
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "This is perhaps the grandest, fanciest Asian noodle joint in all the world with it’s intriguingly ornate sculpture outside and magnificently airy wooden interior. But give me a steaming 3-seat yatai in Sapporo’s ramen yoko-cho anyday. I would go so far as to say I would prefer a bowl of Sapporo Ichiban instant noodles to the $16 pork “ramen” they serve here.Bottom line: Momofuku serves absurdly expensive and complicated versions of what should be simple, comforting street vendor food. Unlike most authentic Asian noodle restaurants of whatever variety, the portions here are small. You’re paying for ambiance and for the privilege of eating simple working class food complicated to the point where it is not actually delicious and does not actually resemble what it purports to be. Even something simple like iced tea is disappointing here. For $5 you’d expect an “iced green tea” to be a tall frosty glass of emerald green matcha. Nope. You get a small glass of sweetened brown sencha. If you want ramen go to a real ramen restaurant where the ramen tastes like ramen and the tea is free. Momofuku looks magnificent, but this emperor most definitely has no clothes.",
    datePublished: "2017-10-23",
    summary:
      "But give me a steaming 3-seat yatai in Sapporo’s ramen yoko-cho anyday.",
    concepts: [
      { content: "noodle" },
      { content: "tea" },
      { content: "restaurant" },
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "First was very excited to eat at momofuku but I was a bit disappointed. I ate at momofuku New York before so i can’t help myself to compare. The pork bun and pork belly ramen:The ramen was average, the noodle was a bit different. Although, it was flavourful. Pork bun, the fat did not melt in my mouth it was in New York. It was hard to eat the bun because the pork was not that tender and not enough green onions and cucumber. As expected it will be expensive compared to a normal ramen house, but I’m willing to pay just to taste the pork buns again. But, probably not in Toronto anymore. ",
  ...
  },
  {
    ...
    origin: "TripAdvisor",
    description:
      "A bite from our full experience review -\n“We caught ourselves feeling that we were inside a deep bowl of noodles - bland and beige, warm, murky, but lacking character.”",
