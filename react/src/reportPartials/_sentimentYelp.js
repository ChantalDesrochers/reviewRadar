...
class PieSentimentYelp extends Component {
  ...
  parseSentimentsYelp = (reviews) => {
    let yelpReviews = reviews.filter(review => review.origin.includes("Yelp"))
  ...
  render() {
    ...
    return (
      ...
      <h2>What your customers on Yelp think</h2>
        <Pie data={this.parseSentimentsYelp(this.props.reviews)} ref="myChart"
  width={5}
  height={5}
  options={{
