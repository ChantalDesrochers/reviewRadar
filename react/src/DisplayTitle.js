...
class DisplayTitle extends Component {
    ...
    prepareHtml =() => {
        ...
        if(this.props.s.displaying === 'keyword' && this.props.s.displayModifier === 'volume') {
           return( <Typography variant="title" style={{fontSize:'1.4em', paddingBottom:'1em', float:'left'}}> Reviews about <b style={{fontSize:'2em'}}>{this.props.s.keywordChartTarget}</b> </Typography> )
